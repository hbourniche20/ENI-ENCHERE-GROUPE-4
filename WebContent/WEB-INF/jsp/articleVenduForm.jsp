...
<div class="row">
	<div class="col">
		<div class="form-group row">					
		   	...
		   	<div class="col-sm-9">
		      	<input type="text" name="nom" class="form-control" id="nom" value="${ article.getNomArticle() }" >
		   	</div>
		</div>
		<div class="form-group row">
		   	<label for="description" class="col-sm-3 col-form-label">Description :</label>
		   	<div class="col-sm-9">
		      	<input type="text" name="description" class="form-control" id="description" value="${ article.getDescription() }" >
			</div>
		</div>
		<div class="form-group row">
		...
		<div class="form-group row">
		   	...
		   	<div class="col-sm-9">
		      	<input type="number" name="miseAPrix" class="form-control" id="miseAPrix" value="${ article.getMiseAPrix() }" >
		   	</div>
		</div>
		<div class="form-group row">
		   	<label for="dateDebut" class="col-sm-3 col-form-label">Début de l'enchère : </label>
		   	<div class="col-sm-9">
		      	<input type="date" name="dateDebut" class="form-control" id="dateDebut" value="${ article.getDateDebutEncheres() }">
		   	</div>
		</div>
		<div class="form-group row">
		   	<label for="dateFin" class="col-sm-3 col-form-label">Fin de l'enchère :</label>
		   	<div class="col-sm-9">
		     	<input type="date" name="dateFin" class="form-control" id="dateFin" value="${ article.getDateFinEncheres() }" >
		   	</div>
		</div> 					
	</div>
</div>
...
<div class="row">
	<div class="col">
		<div class="form-group row">
		   	...
		   	<div class="col-sm-9">
		      	<input type="text" name="rue" class="form-control" id="rue" value="${ article.getLieuRetrait().getRue() == null ? sessionScope.user.getRue() : article.getLieuRetrait().getRue() }" > 
		   	</div>
		</div>
		<div class="form-group row">
		   	<label for="codePostal" class="col-sm-3 col-form-label">Code postal : </label>
		   	<div class="col-sm-9">
		      	<input type="text" name="codePostal" class="form-control" id="codePostal" value ="${article.getLieuRetrait().getCodePostal() == null ? sessionScope.user.getCodePostal() : article.getLieuRetrait().getCodePostal()} ">
		   	</div>
		</div>
		<div class="form-group row">
		   	<label for="ville" class="col-sm-3 col-form-label">Ville :</label>
		   	<div class="col-sm-9">
		   	  	<input type="text" name="ville" class="form-control" id="ville" value ="${article.getLieuRetrait().getVille() == null ? sessionScope.user.getVille() : article.getLieuRetrait().getVille()}" >
   		    </div>
		</div>	
	</div>
</div>
